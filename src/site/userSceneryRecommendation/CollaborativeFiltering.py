...
footData = pd.read_csv('foot.csv',dtype='str')
...
index2ItermDict=dict( zip(iterm['itermId'],iterm['景区码']))
iterm2IndexDict=dict( zip(iterm['景区码'],iterm['itermId']))
# 保存物品编号ID和物品码的对应关系，方便以后查找具体物品。
...
pd.DataFrame(VT).to_csv("EmbedingScenery.csv")
